...
\graphicspath{{../x210v3/images/}}

\lstset{language=C, extendedchars=false,%
    showstringspaces=false, basicstyle=\tt,
    framerule=0pt,backgroundcolor=\color{gray!20},
    inputpath=./program,
    morekeywords={ssize_t,size_t}}
...
\titleformat{\chapter}[display]
    {\bfseries\Large}
    {\filleft{\chaptername} \huge\thechapter}
    {4ex}
    {\titlerule \vspace{2ex}\MakeUppercase{\Large \tt #1}}
    [\vspace{2ex} \titlerule]
